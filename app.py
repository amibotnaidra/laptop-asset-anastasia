...
with st.container():
    ...
    with left_column:
        st.write(
            ...
            - Display Name: Anastasia Evanjelita Fauzia Alkas
            - User Principal Name: anastasia.evanjelita@gobel.co.id
            - Model Name: Lenovo Legion 5 16IRX9
            - PC Name: IIAPG-Anas
            - Laptop Code: IIAPG-NB24-006
            - Job Title: Procurement Staff
            - Department: IIAPG
            - Email: anastasia.evanjelita@outlook.com
